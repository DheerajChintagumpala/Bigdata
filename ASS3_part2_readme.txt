...
I have used the twitter-combined.txt from SNAP repository. all the details are availabe in the below github repository. https://github.com/DheerajChintagumpala/Bigdata/tree/main